...
function getUsageHelp(commandName) {
    ...
    var text = 'Expected usage: \n' +
        ...
        createSample('#channel') + ' -- Sends to the specified channel.\n' +
...
function getFullHelp(commandName) {
    var text =
        'Allows to send suggestion message messages to the Department Head.\n' +
        ...
        'Messages and authors are not stored.\n' +
        '\n' +
